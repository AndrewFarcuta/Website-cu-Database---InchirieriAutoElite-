...
<body id="wrapper">
    ...
    <div class="row">
        ...
        <div class="column-right">
            ...
            <img id="coast" src="images/bug.jpg" height="350px;" width="100%" />
            <section>
                <h2>Mașini Disponibile</h2>



                <?php 
                $connection = mysqli_connect('localhost', 'root', ''); // Câmpul gol reprezintă parola
                mysqli_select_db($connection,'rental _company');

                $query = "SELECT * FROM cars"; // Nu ai nevoie de punct și virgulă ca în SQL
