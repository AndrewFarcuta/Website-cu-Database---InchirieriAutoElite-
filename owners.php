...
<body id="wrapper">
    ...
    <div class="row">
        ...
        <div class="column-right">
            ...
            <img id="coast" src="images/fer1.jpg" height="350px;" width="100%" />
            <section>
                <h2>Proprietari și mașinile lor</h2>
                ...
                $query = "SELECT owners.O_TYPE, cars.MODEL, cars.TYPE FROM owners inner join cars on owners.O_ID=cars.O_ID;"; 
                $result = mysqli_query($connection,$query);
                
                

                echo "<table>"; // începe un tag de tabel în HTML
                echo "    <tr>
                ...
                {   //Creează un ciclu pentru a parcurge rezultatele
                echo "<tr><td>". $row['O_TYPE'] . "</td><td>" . $row['MODEL'] . "</td><td>" . $row['TYPE'] . "</td></tr>";  //$row['index'] indexul aici este numele unui câmp
                }

                echo "</table>"; // Închide tabelul în HTML
